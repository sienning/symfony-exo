...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            'App\\Controller\\AdminSecurityContollerController' => 'getAdminSecurityContollerControllerService',
            'App\\Controller\\ApiArticleController' => 'getApiArticleControllerService',
            'App\\Controller\\ApiCommentController' => 'getApiCommentControllerService',
            'App\\Controller\\ArticleController' => 'getArticleControllerService',
            'App\\Controller\\CitiesController' => 'getCitiesControllerService',
    ...
    /**
     * Gets the private '.service_locator.XDCBnHs' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_XDCBnHsService()
    {
        return $this->privates['.service_locator.XDCBnHs'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
    ...
    protected function getSecurity_ContextListener_0Service()
    {
        return $this->privates['security.context_listener.0'] = new \Symfony\Component\Security\Http\Firewall\ContextListener(($this->privates['security.untracked_token_storage'] ?? ($this->privates['security.untracked_token_storage'] = new \Symfony\Component\Security\Core\Authentication\Token\Storage\TokenStorage())), new RewindableGenerator(function () {
            ...
            yield 1 => ($this->privates['security.user.provider.concrete.admin_provider'] ?? $this->load('getSecurity_User_Provider_Concrete_AdminProviderService'));
            yield 2 => ($this->privates['security.user.provider.concrete.user_provider'] ?? $this->load('getSecurity_User_Provider_Concrete_UserProviderService'));
        }, 3), 'admin', ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())), ($this->privates['security.event_dispatcher.admin'] ?? $this->getSecurity_EventDispatcher_AdminService()), ($this->privates['security.authentication.trust_resolver'] ?? ($this->privates['security.authentication.trust_resolver'] = new \Symfony\Component\Security\Core\Authentication\AuthenticationTrustResolver())), [0 => ($this->privates['security.token_storage'] ?? $this->getSecurity_TokenStorageService()), 1 => 'enableUsageTracking']);
    }
    ...
    protected function getSecurity_ContextListener_1Service()
    {
        return $this->privates['security.context_listener.1'] = new \Symfony\Component\Security\Http\Firewall\ContextListener(($this->privates['security.untracked_token_storage'] ?? ($this->privates['security.untracked_token_storage'] = new \Symfony\Component\Security\Core\Authentication\Token\Storage\TokenStorage())), new RewindableGenerator(function () {
            ...
            yield 1 => ($this->privates['security.user.provider.concrete.admin_provider'] ?? $this->load('getSecurity_User_Provider_Concrete_AdminProviderService'));
            yield 2 => ($this->privates['security.user.provider.concrete.user_provider'] ?? $this->load('getSecurity_User_Provider_Concrete_UserProviderService'));
        }, 3), 'api', ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())), ($this->privates['security.event_dispatcher.api'] ?? $this->getSecurity_EventDispatcher_ApiService()), ($this->privates['security.authentication.trust_resolver'] ?? ($this->privates['security.authentication.trust_resolver'] = new \Symfony\Component\Security\Core\Authentication\AuthenticationTrustResolver())), [0 => ($this->privates['security.token_storage'] ?? $this->getSecurity_TokenStorageService()), 1 => 'enableUsageTracking']);
    }
    ...
    protected function getSecurity_EventDispatcher_ApiService()
    {
        ...
        $instance->addListener('Symfony\\Component\\Security\\Http\\Event\\CheckPassportEvent', [0 => function () {
            return ($this->privates['security.listener.api.user_provider'] ?? $this->load('getSecurity_Listener_Api_UserProviderService'));
        }, 1 => 'checkPassport'], 2048);
        $instance->addListener('Symfony\\Component\\Security\\Http\\Event\\LoginSuccessEvent', [0 => function () {
    ...
    {
        return $this->privates['security.firewall.map'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallMap(($this->privates['.service_locator.XDCBnHs'] ?? $this->get_ServiceLocator_XDCBnHsService()), new RewindableGenerator(function () {
    ...
    protected function getValidator_BuilderService()
    {
        ...
        $instance->setConstraintValidatorFactory(new \Symfony\Component\Validator\ContainerConstraintValidatorFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'App\\Validator\\BannedWordsValidator' => ['privates', 'App\\Validator\\BannedWordsValidator', 'getBannedWordsValidatorService', true],
            'App\\Validator\\LimitContentValidator' => ['privates', 'App\\Validator\\LimitContentValidator', 'getLimitContentValidatorService', true],
            ...
            'App\\Validator\\BannedWordsValidator' => '?',
            'App\\Validator\\LimitContentValidator' => '?',
