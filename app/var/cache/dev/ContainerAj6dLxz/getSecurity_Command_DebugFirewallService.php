...
class getSecurity_Command_DebugFirewallService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $container->privates['security.command.debug_firewall'] = $instance = new \Symfony\Bundle\SecurityBundle\Command\DebugFirewallCommand($container->parameters['security.firewalls'], ($container->privates['.service_locator.XDCBnHs'] ?? $container->get_ServiceLocator_XDCBnHsService()), ($container->privates['.service_locator.Ou6pzby'] ?? $container->load('get_ServiceLocator_Ou6pzbyService')), ['admin' => [0 => ($container->privates['App\\Security\\AdminAuthenticator'] ?? $container->load('getAdminAuthenticatorService'))], 'api' => [0 => ($container->privates['App\\Security\\ApiTokenAuthenticator'] ?? ($container->privates['App\\Security\\ApiTokenAuthenticator'] = new \App\Security\ApiTokenAuthenticator()))]], false);
